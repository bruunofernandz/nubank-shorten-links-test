...
void main() {
  testWidgets('ButtonWidget displays the correct text', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('ButtonWidget calls onPressed when tapped', (
    WidgetTester tester,
  ) async {
    bool pressed = false;
    await tester.pumpWidget(
  ...
  testWidgets('ButtonWidget has correct minimum size and border radius', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
